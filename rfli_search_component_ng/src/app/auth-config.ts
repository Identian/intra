...
import { clientId, clientIdToUse, tenantToUse } from 'src/environments/environment';
...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
            authority: `https://login.microsoftonline.com/${tenantToUse}`,
        },
        resetPassword: {
...
export const msalConfig: Configuration = {
    auth: {
        clientId: clientIdToUse, // This is the ONLY mandatory field that you need to supply.
