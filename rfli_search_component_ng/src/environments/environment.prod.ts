...
export const environment = {
  production: false,
  isin: `${urlToUse}/${envToUse}/isin-search/isines`,
  issuers:  `${urlToUse}/${envToUse}/isin-search/issuers`,
  titles: `${urlToUse}/${envToUse}/isin-search/titles`,
  userIsines: `${urlToUse}/${envToUse}/isin-track/user-isines`
};